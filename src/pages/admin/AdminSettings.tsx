  ...
  const handleToggleSetting = (category: string, setting: string) => {
    if (category === 'notifications') {
      ...
      setSettings({
        ...
        security: {
          ...settings.security,
          [setting]: !settings.security[setting as keyof typeof settings.security],
        }
      });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-mindease-background">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        ...
        <p className="text-gray-600 mb-8">Configure your admin account and system preferences</p>
            ...
            <Card>
              ...
              <CardContent>
                <nav className="space-y-1">
                  <a href="#account" className="flex items-center px-3 py-2 rounded-md bg-mindease-primary/10 text-mindease-primary font-medium">
                  ...
                  <a href="#security" className="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      This email will be used for admin notifications and account recovery
                    </p>
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <input 
                          ...
                          onChange={() => handleToggleSetting('notifications', 'emailAlerts')}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <input 
                          ...
                          onChange={() => handleToggleSetting('notifications', 'systemAlerts')}
                          className="w-5 h-5 rounded text-mindease-primary focus:ring-mindease-primary/20"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <input 
                          ...
                          onChange={() => handleToggleSetting('notifications', 'userRegistrations')}
                          className="w-5 h-5 rounded text-mindease-primary focus:ring-mindease-primary/20"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <input 
                          ...
                          onChange={() => handleToggleSetting('notifications', 'doctorRegistrations')}
                          className="w-5 h-5 rounded text-mindease-primary focus:ring-mindease-primary/20"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <input 
                          ...
                          onChange={() => handleToggleSetting('notifications', 'paymentAlerts')}
                          className="w-5 h-5 rounded text-mindease-primary focus:ring-mindease-primary/20"
                        />
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-sm text-muted-foreground">
                        Automatically sign out after inactivity period (5-120 minutes)
                      </p>
                    </div>
                    ...
                    <div className="p-4 border rounded bg-yellow-50 border-yellow-200">
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-medium text-yellow-800">API Access Keys</h4>
                          <p className="text-sm text-yellow-700 mt-1">
                            Your admin account has access to sensitive API keys. 
                            Please ensure these are kept secure and rotated regularly.
                          </p>
                          <Button 
                            variant="outline" 
